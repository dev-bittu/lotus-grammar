...
In *lotus*, strings are sequences of characters and are defined by enclosing text in double quotes (`" "`). Strings are commonly used to represent textual data and can be manipulated in various ways.
...
#### **2. String Modifying**
Strings in *lotus* are immutable, meaning you cannot directly change individual characters. However, you can create new strings based on modifications.
...
- **Using Template Strings (if supported):**
  (In *lotus*, template strings allow embedding variables directly in the string.)
...
#### **6. String Methods**
*lotus* provides several built-in methods for string manipulation:
...
### **String Methods in *lotus***

String methods provide various functions to manipulate or query strings. Here are some of the most useful string methods available in *lotus*:
...
Strings in *lotus* are versatile and provide various functions to help with string manipulation. Whether you need to slice, modify, concatenate, or format strings, *lotus* provides an easy-to-use syntax.